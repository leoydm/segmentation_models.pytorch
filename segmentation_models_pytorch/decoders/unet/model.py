...
class UnetRefiner(RefinerModel):
    """
    U-Net is a fully convolutional neural network architecture designed for semantic image segmentation.
    ...
    def __init__(
        ...
        **kwargs: dict[str, Any],
        ...
        if aux_params is not None:
            self.classification_head = ClassificationHead(
                in_channels=mask_encoder_out_channels[-1], **aux_params
            )
        else:
            self.classification_head = None
...
#
# class UnetRRefiner(RRefinerModel):
#     """
#     U-Net is a fully convolutional neural network architecture designed for semantic image segmentation.
#
#     It consists of two main parts:
